...
class DatabaseManager(object):
    ...
    def generate_data(self, decks = 1):
        ...
        nr_of_cards = self.create_attribute("nr_of_cards" , "number" , 0)
        nr_of_cards_studied = self.create_attribute("nr_of_cards_studied" , "number" , 0)
        nr_of_cards_to_study = self.create_attribute("nr_of_cards_to_study" , "number" , 0)
        nr_of_cards1 = self.create_attribute("nr_of_cards" , "number" , 0)
        nr_of_cards_studied1 = self.create_attribute("nr_of_cards_studied" , "number" , 0)
        nr_of_cards_to_study1 = self.create_attribute("nr_of_cards_to_study" , "number" , 0)
        ...
        while i < decks:
            ...
            d = self.create_deck(cards, [author, date, name, nr_of_cards, nr_of_cards_studied, nr_of_cards_to_study])
            e = self.create_deck(cards1, [author, date, name1, nr_of_cards1, nr_of_cards_studied1, nr_of_cards_to_study1])
